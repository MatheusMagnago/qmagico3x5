...
document.addEventListener("DOMContentLoaded", t3);
...
function t1() {
    ...
    botao.addEventListener("click", insereTabela);  
...
function t2() {
    ...
    botao2.innerHTML = "4x4";
    document.body.append(botao2); 
    botao2.addEventListener("click", insereTabela);  
    botao2.appendChild(document.createTextNode(" "));
...
function t3() {
    ...
    botao3.innerHTML = "5x5";
    document.body.append(botao3); 
    botao3.addEventListener("click", insereTabela);  
    botao3.appendChild(document.createTextNode(" "));
